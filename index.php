...
?>
				...
				<div class="column ccont-left col-lg-6">
					<img src="assets/images/gp1.jpg" class="img-responsive" alt="">
				</div>
			</div>
		</div>
	</div>
...
?>
                <div class="tatest-top mt-md-5 mt-4">
                        <div class="price-box btn-layout bt6">
                            <div class="grid grid-column-2">
                                    <div class="column-6">
                                            <img src="assets/images/gp3.jpg" alt="" class="img-fluid">
                                        </div>
                                <div class="column1">
